...
for (let i = 1; i <= 100; i++) {
    ...
    } // Se il numero è divisibile solo per 3, assegniamo "Fizz"
    else if (i % 3 === 0) {
        output = "Fizz";

    } // Se il numero è divisibile solo per 5, assegniamo "Buzz"

    else if (i % 5 === 0) {
        output = "Buzz"

    } // Se non si verifica nessuna condizione, assegniamo il numero stesso 
    else {
        output = i
    }
